    ...
    QWidget(parent)
{
    ...
    functionSel->addItem("pmg/pg");
    functionSel->addItem("LocSymSqrt7");
    functionSel->addItem("CTSymSqrt7");
    functionSel->addItem("LocSym2Sqrt7");
...
//    worldheightE->setSizePolicy(QSizePolicy::Minimum, QSizePolicy::Minimum);
    ...
    functionSel->setCurrentIndex(15);    //set up current function
...
void interface::changeFunction(int index)
{
    ...
    case 15:
        ...
        break;
    case 16:
        f = new locSymFunction();
        colorwheelSel->setCurrentIndex(9);
        break;
    case 17:
        f = new locSymCTFunction();
        colorwheelSel->setCurrentIndex(9);
        break;
    case 18:
        f = new locSym2Function();
        colorwheelSel->setCurrentIndex(9);
        break;
    case 19:
        f = new p31mFunction();
